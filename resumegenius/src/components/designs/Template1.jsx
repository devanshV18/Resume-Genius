...
const Template1 = () => {
  ...
  const generatePDF = async () => {
    const element = resumeRef.current;
    if(!element) {
      toast.info("Unable to Capture the resume")
      return;
    }
    ...
    htmlToImage.toPng(element).then((dataURL) => {
      ...
      pdf.addImage(dataURL, "PMG", 0, verticalMargin, imgWidth, imgHeight)
      pdf.save("resume.pdf")
