      ...
      >
        ...
        <div className='w-full flex items-center justify-start overflow-x-scroll gap-6 scrollbar-none'>
            {FiltersData.map((item) => (
                ...
                key={item.id}
                className={`border border-white rounded-xl px-6 py-2 cursor-pointer group hover:shadow-md group hover:bg-blue-700 ${filterData.searchTerm === item.value ? "bg-blue-700" : "bg-black"}`}
                >
